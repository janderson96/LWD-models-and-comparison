# -*- coding: utf-8 -*-
"""
Created on Sat Jul  4 10:29:51 2020
@author: Jake
"""
...
CRC = falls_data['src'].values

## Final variable in model_data is the SRC threshold ##
## Threshold values (m) ##
## Moose Mountain = 0.0000477
## Woods Creek = 0.00000346
## Falls Creek = 0.00000214
## Soapgrass Mountain = 0.00002662
model_data = CRC_threshold(datetime_time, CRC, 0.00000214)
...
for i in range(366):
    ...
    for j in range(24):
        ...
        #print('val_hour_sum =', validation_hour_sum)
